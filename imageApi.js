...
(function () {
  ...
  async function generateInteriorFromPrompt(promptText) {
    ...
    if (typeof setMessage === "function") {
      setMessage(
        "Thank you! Your responses have been recorded. Designing the living room that fits your preference..."
      );
    }
    ...
    try {
      ...
      if (data.image_base64 && imgEl) {
        ...
        if (typeof setMessage === "function") {
          setMessage(
            "Thank you! Your responses have been recorded. Here is a living room design that fits your preference."
          );
        }
